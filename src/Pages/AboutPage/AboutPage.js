  ...
  return (
    <div className="AboutPage" id="about">
      <div className="abtPage-content">
        ...
        <div className="abtPage-text" data-aos="fade-right">
          ...
          <p className="bio">
            ...
            still enthusiastically grabbing onto any other programming languages
            and frameworks.
          </p>
          <div>
            <a
              target="_blank"
              rel="noreferrer"
              href="https://www.linkedin.com/in/maryam-abdel-karim-9548771bb"
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="mailto:maryam.abdelkarim7@gmail.com?body=My custom mail body"
              className="social-link"
            >
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://github.com/MaryamAK7"
              className="social-link"
            >
              <img src={github} alt="" />
            </a>
          ...
          <a
            target="_blank"
            rel="noreferrer"
            href="https://drive.google.com/file/d/1Emg2fhacylQFvlS-MQBJPsmSMPDKAwlp/view?usp=sharing"
          >
